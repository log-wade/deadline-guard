  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-safe": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(152 76% 40% / 0.4)" },
          "50%": { boxShadow: "0 0 0 8px hsl(152 76% 40% / 0)" },
        },
        "pulse-upcoming": {
      ...
      animation: {
        ...
        "pulse-upcoming": "pulse-upcoming 2s ease-in-out infinite",
        "pulse-overdue": "pulse-overdue 1.5s ease-in-out infinite",
      },
    },
  },
